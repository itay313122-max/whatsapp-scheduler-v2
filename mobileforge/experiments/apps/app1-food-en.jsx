function App() {
  ...
  return (
    <div className="app-shell">
      <style>{`:root{--c-from:#FF6B35;--c-to:#E63946;--c-primary:#FF6B35;--c-primary-light:rgba(255,107,53,0.1);--c-bg:#fff7f3;--c-font:'Inter',system-ui,sans-serif;}`}</style>
      ...
      {count > 0 && (
        <div style={{ position: 'absolute', left: 16, right: 16, bottom: 92, background: 'var(--c-primary)', color: '#fff', borderRadius: 16, padding: '14px 18px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', boxShadow: '0 10px 30px rgba(255,107,53,0.4)' }}>
